...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier specifier:(PSSpecifier *)specifier {
	...
	if (self) {
		...
		if (specifier.properties[@"github"]) {
			self.githubUsername = specifier.properties[@"github"];
			specifier.properties[@"url"] = [@"https://github.com/" stringByAppendingString:specifier.properties[@"github"]];
		}
...
- (void)fetchImage {
	dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
		...
		if (self.githubUsername) url = [NSString stringWithFormat:@"https://github.com/%@.png", self.githubUsername];
